<template>
  <div class="aside">
      ...
      <el-menu background-color="#353b4e" text-color="#adafb5" class="elmenu" router>
          ...
          <el-submenu index="2">
              ...
              <el-menu-item index="/home/img">图文数据</el-menu-item>
              <el-menu-item index="/home/fansIntroduce">粉丝概况</el-menu-item>
